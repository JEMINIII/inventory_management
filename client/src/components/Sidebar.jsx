...
import {
  ...
  import { UnorderedListOutlined, ArrowUpOutlined, ArrowDownOutlined, CarryOutOutlined, MoneyCollectOutlined } from '@ant-design/icons';
...
const Sidebar = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:8082/sidebar')
      .then(response => {
